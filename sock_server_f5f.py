        ...
        while True:
            ...
            if data:
                ...
                for detection in detections:
                        ...
                        tmp_mid.append(l_adj + (r_adj - l_adj)/2)
                ...
                if(len(detections)==0):
                      ...
                      for i in tmp_mid:
                         ...
                         if(i<=270):
                            ...
                            string_list[7]="1"
                      #instr = "00000001"
                      instr=string_list[0]+string_list[1]+string_list[2]+string_list[3]+string_list[4]+string_list[5]+string_list[6]+string_list[7]
                      send_msg(instr)
                      engine.say(min_object+'is '+str(min_depth)+' feet')
                      engine.runAndWait()
                else:
                      instr = "00000000"
                      send_msg(instr)
